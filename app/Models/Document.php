...
class Document extends Model
{
    ...
    protected $fillable = ['user_id', 'reciever_id','course_id','educational_attainment','date_submitted','isForwarded' ,'loi', 'ce', 'cr', 'nce','hdt','f137_8','abcb','mc','nbc','ge','pc','rl','cgmc', 'cer'];
